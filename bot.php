...
~ @Y_4_V 🍂',
		    ...
		    $bot->sendMessage([
		       'chat_id'=>$chatId,
                'message_id'=>$mid,
                'text'=>"𝙷𝙸 𝙱𝚁𝙾 𝙸𝙽 𝚃𝙷𝙴 𝙲𝙾𝙽𝚃𝚁𝙾𝙻 𝙱𝚈 ~ @Y_4_V",
                'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
            ...
            $bot->sendMessage([
		       'chat_id'=>$chatId,
                'message_id'=>$mid,
                'text'=>".𖡃. 𝐂𝐡 :- l @TTTPTTTTT
𝐓𝐞𝐥𝐞 : @Y_4_V |",

              ]);   
              
           } if($text == '️ما هوا بوت صيد والمتاحات 🤔'){ 
            $bot->sendMessage([
         'chat_id'=>$chatId,
                'message_id'=>$mid,
...
",
           ...
           } if($text == '️- فيديو تخطي حظر وهمي ✅'){
                  $bot->sendvideo([ 
                  'chat_id'=>$chatId,                  'video'=>"https://t.me/SUPERX1/8",

              ]);
              
              } if($text == '️- فيديو طريقه توصيل الريست 🎬'){
                  $bot->sendvideo([ 
                  'chat_id'=>$chatId,                  'video'=>"https://t.me/HH7H9/7146",
				  'caption'=> 'تطبيق توصيل الريست🔓
...
لشراء نسخه مراسلة المطور 👁‍🗨',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'▫️| مطور البوت','url'=>'t.me/Y_4_V']],
                       [['text'=>"▪️| قناه صيد المشتركين", 'url'=>"t.me/TTTPTTTTT"]],
                  ]
							])
					]);
				}
